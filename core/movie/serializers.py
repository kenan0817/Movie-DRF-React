...
class MovieSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model=Movie
        fields=['id','title','description','studio','studio_id','genres','genre_ids','poster_image','background_image','trailer_url','imdb','duration','local','user','relaese','created','updated','movie_images']
